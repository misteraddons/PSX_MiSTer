...
#set_location_assignment PIN_AF25 -to SDIO_DAT[0]_VGA_R[0]
#set_location_assignment PIN_AF23 -to SDIO_DAT[1]_VGA_R[1]
#set_location_assignment PIN_AD26 -to SDIO_DAT[2]_VGA_G[0]
#set_location_assignment PIN_AF28 -to SDIO_DAT[3]_VGA_G[1]
#set_location_assignment PIN_AF27 -to SDIO_CMD_VGA_B[0]
#set_location_assignment PIN_AH26 -to SDIO_CLK_VGA_B[1]

set_location_assignment PIN_AF25 -to VGA_R[0]
set_location_assignment PIN_AF23 -to VGA_R[1]
set_location_assignment PIN_AE17 -to VGA_R[2]
set_location_assignment PIN_AE20 -to VGA_R[3]
set_location_assignment PIN_AF20 -to VGA_R[4]
set_location_assignment PIN_AH18 -to VGA_R[5]
set_location_assignment PIN_AH19 -to VGA_R[6]
set_location_assignment PIN_AF21 -to VGA_R[7]

set_location_assignment PIN_AD26 -to VGA_G[0]
set_location_assignment PIN_AF28 -to VGA_G[1]
set_location_assignment PIN_AE19 -to VGA_G[2]
set_location_assignment PIN_AG15 -to VGA_G[3]
set_location_assignment PIN_AF18 -to VGA_G[4]
set_location_assignment PIN_AG18 -to VGA_G[5]
set_location_assignment PIN_AG19 -to VGA_G[6]
set_location_assignment PIN_AG20 -to VGA_G[7]

set_location_assignment PIN_AF27 -to VGA_B[0]
set_location_assignment PIN_AH26 -to VGA_B[1]
set_location_assignment PIN_AG21 -to VGA_B[2]
set_location_assignment PIN_AA20 -to VGA_B[3]
set_location_assignment PIN_AE22 -to VGA_B[4]
set_location_assignment PIN_AF22 -to VGA_B[5]
set_location_assignment PIN_AH23 -to VGA_B[6]
set_location_assignment PIN_AH21 -to VGA_B[7]
